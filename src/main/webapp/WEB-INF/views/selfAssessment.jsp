...
<body>
<div id="property-data" style="display: none;" property-data="${properties}"></div>
	<div class="row mt-5">
			...
			<form>
				...
				<div class="form-group row">
					<label for="totalTax" class="col-sm-2 col-form-label">Total
						Payable Tax</label>
					<div class="col-sm-10">
						<input readonly onfocus="calculateTax()" type="number" class="form-control" id="totalTax" value=""
							placeholder="">
					</div>
				</div>
				<div class="form-group row">
	...
	<script type="text/javascript" src="/resources/js/selfAssessment.js"></script>
